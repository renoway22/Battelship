...
public class TournamentHandler {
    ...
    private static int tournamentRoundsPlayed = 0;
    ...
    public static void main(String[] arguments) throws Exception {
        ...
        do {
            ...
            String clazzName = Input.next();
            if (clazzName.contentEquals("")) {
    ...
    private static void printTournamentState() {
        ...
        System.out.println(playerOne + " VS " + playerTwo + "! Tournament round " + tournamentRoundsPlayed + (tournamentRoundsCancelled > 0 ? " (" + tournamentRoundsCancelled + " cancelled)" : "") + ".");
    ...
    private static void runOneTournamentRound() throws Exception {
        ...
        try {
            ...
            exceptionMessage = "Tournament round " + tournamentRoundsPlayed + " had to be cancelled due to unforseen problems. Player " + playerOne + " could not place the ships. ";
        }
        try {
            if (exceptionMessage.equals(""))
                playerTwo.placeShips();
        } catch (Exception e) {
            exceptionMessage = "Tournament round " + tournamentRoundsPlayed + " had to be cancelled due to unforseen problems. Player " + playerTwo + " could not place the ships. ";
        }
        try {
            if (exceptionMessage.equals(""))
                playUntilTheEnd();
        } catch (Exception e) {
            exceptionMessage = "Tournament round " + tournamentRoundsPlayed + " had to be cancelled due to unforseen problems. " + e.getMessage();
        }
        if (!exceptionMessage.equals("")) {
            tournamentRoundsCancelled += 1;
            drawAFancyLine(60, 0, 1);
